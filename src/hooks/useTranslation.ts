...
const dictRUS: Record<string, string> = {
  ...
  'Privacy & Offline': 'Приватность и офлайн',
  'Syncing...': 'Синхронизация...',
  'Never synced': 'Нет синхронизации',
  'Strict Offline Mode': 'Строгий офлайн-режим',
  'Disable cloud sync & AI requests': 'Отключает облачную синхронизацию и AI-запросы',
  'Blocked by Paranoia Mode': 'Заблокировано офлайн-режимом',
...
const dictGR: Record<string, string> = {
  ...
  'Privacy & Offline': 'Απόρρητο & Εκτός σύνδεσης',
  'Syncing...': 'Συγχρονισμός...',
  'Never synced': 'Ποτέ δεν συγχρονίστηκε',
  'Strict Offline Mode': 'Αυστηρή λειτουργία εκτός σύνδεσης',
  'Disable cloud sync & AI requests': 'Απενεργοποιεί συγχρονισμό cloud & αιτήματα AI',
  'Blocked by Paranoia Mode': 'Αποκλείστηκε από τη λειτουργία εκτός σύνδεσης',
  'Restore from Cloud': 'Επαναφορά από το Cloud',
  'Entries restored': 'Καταχωρίσεις επαναφέρθηκαν',
  'Nothing to restore': 'Τίποτα προς επαναφορά',
  'Sync': 'Συγχρονισμός',
